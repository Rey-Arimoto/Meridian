/**
 * PR156: v1.4 Auto Execution Policy - Guards (READ-ONLY)
 *
 * Purpose:
 *   Validate that policy/heartbeat output does not contain forbidden content.
 *   Constitutional enforcement layer for warnings/messages.
 *
 * Constitutional Constraints:
 *   - No numeric values in warnings/messages (internal calculations OK)
 ...
 *
 * Numeric values should not appear in warnings/messages.
 ...
 *
 * This is the main validation function for warnings/messages.
...
/**
 * Validate policy output (check for violations)
 *
 * @param warnings - Warning strings
 * @returns Validation result
 *
 * Use this to check policy output before returning.
 * Returns list of violations found.
 */
export function validatePolicyOutput(warnings: string[]): {
  valid: boolean;
  violations: string[];
} {
